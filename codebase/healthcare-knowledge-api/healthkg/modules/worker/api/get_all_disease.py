...
from jio.brain.proto.knowledge.healthcare.req_res.get_all_disease_pb2 import GetAllDiseaseResponse
import copy

class GetAllDiseaseWorker:
    ...
    def transform_request(self, request):
        ...
        knowledge_request = {"predicate_name": "is_a", "from_node": "healthcare_disease"}
