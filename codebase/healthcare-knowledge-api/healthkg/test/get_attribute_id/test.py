from jio.brain.proto.knowledge.healthcare.req_res.get_attribute_id_pb2 import GetAttributeIdRequest
...
def test():
    ...
    try:
        request = GetAttributeIdRequest(attribute_name="Cough|Type")
        response = stub.GetAttributeId(request)
