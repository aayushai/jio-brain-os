from jio.brain.proto.knowledge.healthcare.req_res.search_diseases_pb2 import SearchDiseasesRequest
...
logger = get_logger("root", "search_diseases")
...
def test():
    ...
    try:
        request = SearchDiseasesRequest(keyword="can", 
                                        gender=[311], 
                                        age=[42]) 
        response = stub.SearchDiseases(request)
