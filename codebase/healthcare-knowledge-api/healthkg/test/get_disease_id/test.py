from jio.brain.proto.knowledge.healthcare.req_res.get_disease_id_pb2 import GetDiseaseIdRequest
...
logger = get_logger("root", "get_disease_id")
...
def test():
    ...
    try:
        request = GetDiseaseIdRequest(disease_name="Corona")
        response = stub.GetDiseaseId(request)
