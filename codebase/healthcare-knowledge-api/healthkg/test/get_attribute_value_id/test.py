from jio.brain.proto.knowledge.healthcare.req_res.get_attribute_value_id_pb2 import GetAttributeValueIdRequest
...
def test():
    ...
    try:
        request = GetAttributeValueIdRequest(attribute_value_name="Cough|Colour|Yellow")
        response = stub.GetAttributeValueId(request)
