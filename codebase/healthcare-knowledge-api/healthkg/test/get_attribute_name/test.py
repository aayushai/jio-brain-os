from jio.brain.proto.knowledge.healthcare.req_res.get_attribute_name_pb2 import GetAttributeNameRequest
...
logger = get_logger("root", "get_attribute_order")
...
def test():
    ...
    try:
        request = GetAttributeNameRequest(symptom_type_id = 21, 
                                      attribute_type_id = 212) 
        response = stub.GetAttributeName(request)
