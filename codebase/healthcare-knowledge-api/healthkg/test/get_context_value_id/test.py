from jio.brain.proto.knowledge.healthcare.req_res.get_context_value_id_pb2 import GetContextValueIdRequest
...
def test():
    ...
    try:
        request = GetContextValueIdRequest(context_value_name = "Gender|Male") 
        response = stub.GetContextValueId(request)
