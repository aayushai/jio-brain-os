from jio.brain.proto.knowledge.api.data.has_biz_id_pb2_grpc import(
	HasBizIdServiceServicer, # Base class for generated servicer 
	add_HasBizIdServiceServicer_to_server # generated rpc handler	
)
from servings.grpc.service import serve
from db.generic.dao.query_handler import init, execute
from api.has_biz_id.config import *
...
i/p: request
o/p: has_biz_id_API response
'''

class Servicer(HasBizIdServiceServicer):
...
if __name__ == "__main__":
	...
	serve(
			rpc_handler = add_HasBizIdServiceServicer_to_server,
			servicer = Servicer,
			port = SERVER_PORT,
