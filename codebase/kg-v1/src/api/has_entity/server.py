from jio.brain.proto.knowledge.api.data.has_entity_pb2_grpc import(
	HasEntityServiceServicer, # Base class for generated servicer 
	add_HasEntityServiceServicer_to_server # generated rpc handler	
)
from servings.grpc.service import serve
from db.generic.dao.query_handler import init, execute
from api.has_entity.config import *
...
i/p: request
o/p: HasEntityAPI response
'''

class Servicer(HasEntityServiceServicer):
...
if __name__ == "__main__":
	...
	serve(
			rpc_handler = add_HasEntityServiceServicer_to_server,
			servicer = Servicer,
			port = SERVER_PORT,
