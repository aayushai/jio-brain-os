from db.arango.api.delete_entity_alias.query import query
import json
from db.arango.utils.config import *
from db.arango.api.delete_entity_alias.config import *
...
def pre_process_function(request):
	...
	try:
		_query = query%(entity_id,language_val,entity_type)
