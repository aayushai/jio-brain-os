...
from db.arango.api.get_entity_name_by_id.query import query
...
def pre_process_function(request):
	...
	print(collection_name, entity_id)
	_query = query%(collection_name,entity_id)
...
def validate(req):
	...
	if "collection_name" in req and "entity_id" in req:
