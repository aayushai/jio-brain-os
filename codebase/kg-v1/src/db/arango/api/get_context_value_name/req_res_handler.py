...
from db.arango.api.get_context_value_name.query import query
...
def pre_process_function(request):
	...
	print(context_id, value_id)
	_query = query%(context_id, value_id)
...
def validate(req):
	...
	if "context_id" in req and "value_id" in req:
