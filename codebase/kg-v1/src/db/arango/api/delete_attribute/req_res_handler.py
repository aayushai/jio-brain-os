...
from db.arango.api.delete_attribute.query import *
...
def pre_process_function(request):
	...
	_query = query%(entity_type,entity_id,attribute_name,entity_type)
...
def validate(req):
	...
	if "collection_id" in req and "attribute_name" in req:
...
input and sets the status and returns the appropriate response.
i/p:cursor,status
o/p:response
'''
