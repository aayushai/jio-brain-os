...
from db.arango.api.get_entity_id_by_name.query import query
...
def pre_process_function(request):
	...
	entity_name = (request.entity_name).lower()
	print(collection_name, entity_name)
	_query = query%(collection_name,entity_name)
...
def validate(req):
	...
	if "collection_name" in req and "entity_name" in req:
