...
from db.arango.api.get_attribute_value.query import query
...
def pre_process_function(request):
	...
	print(from_node_id, to_node_id, value_id)
	_query = query%(from_node_id, to_node_id, value_id)
...
def validate(req):
	...
	if "from_node_id" in req and "to_node_id" in req:
