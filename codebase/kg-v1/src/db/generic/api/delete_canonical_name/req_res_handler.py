from .config import *
from jio.brain.proto.knowledge.api.data.delete_canonical_name_pb2 import DeleteCanonicalNameResponse
...
def post_process_function(cursor,status): 
	...
	response = DeleteCanonicalNameResponse(status = status) 
