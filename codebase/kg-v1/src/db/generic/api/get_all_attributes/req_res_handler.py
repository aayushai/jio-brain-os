...
from db.generic.api.get_all_attributes.config import *
from google.protobuf.json_format import MessageToDict
from db.generic.services.metadata_dispatcher import *
from db.generic.services.brain_dispatcher import *

from jio.brain.proto.knowledge.api.data.get_all_attributes_pb2 import GetAllAttributesResponse
...
def post_process_function(cursor,status): 
    ...
    response = GetAllAttributesResponse(attribute = cursor["static_cursor"])
